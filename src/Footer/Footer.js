    ...
    <div className="footer">
	  	<div className="footer-about-container">
	  		<div className="footer-about-heading">
	  			...
	  			The survey was conducted as research for a talk that I was asked to give at <a href="http://vi.campjs.com/sessions.html#sdwmyf">CampJS</a> on November 21, 2015.</p>
